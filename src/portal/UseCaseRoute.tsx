...
import { Workspace } from "@aisp/components";
      ...
      <Workspace>
        <div style={{ padding: 40, textAlign: "center" }}>
          ...
          <p style={{ color: "var(--aisp-text-muted)" }}>
            No service is registered under <code>{id}</code>.
          </p>
      ...
      <Workspace>
        <div style={{ padding: 40, maxWidth: 560 }}>
          ...
          <p style={{ marginTop: 14, fontSize: "var(--font-size-sm)" }}>
            This service is <strong>planned</strong>. Register a component in{" "}
            <code>src/portal/useCases.ts</code> to light it up.
          </p>
          <Link to="/" style={{ color: "var(--aisp-link)" }}>
            ← Back to portal home
          </Link>
